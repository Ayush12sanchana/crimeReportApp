...
import com.example.crimereport01.Helpers.CoreHelper;
import com.example.crimereport01.Helpers.CustomModel;
import com.example.crimereport01.Helpers.ImagesAdapter;
...
public class SelectImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = firestore.collection("img");
                ...
                storageReference.child("userData/").child(imagesList.get(i).getImageName()).putFile(imagesList.get(i).getImageURI()).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if (task.isSuccessful()){
                            storageReference.child("userData/").child(imagesList.get(finalI).getImageName()).getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    ...
                                    if (task.isSuccessful()){
                                        ...
                                        Toast.makeText(SelectImageActivity.this, "Couldn't save "+imagesList.get(finalI).getImageName(), Toast.LENGTH_SHORT).show();
                                    }
                            ...
                            progressDialog.setMessage("Uploaded "+counter+"/"+imagesList.size());
                            counter++;
                            Toast.makeText(SelectImageActivity.this, "Couldn't upload "+imagesList.get(finalI).getImageName(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void saveImageDataToFirestore(final ProgressDialog progressDialog) {
        ...
        Intent intent = new Intent(SelectImageActivity.this, MakeEnqueryActivity.class);
        intent.putExtra("hashMap", dataMap);
